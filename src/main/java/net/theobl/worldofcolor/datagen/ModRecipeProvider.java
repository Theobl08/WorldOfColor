...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        dyeRGB(RecipeCategory.DECORATIONS, ModItems.RGB_CUSHION, ItemTags.CUSHIONS, "cushion_dye");
        cushionRecipe(ModBlocks.RGB_WOOL_SLAB.asItem(), ModItems.RGB_CUSHION.asItem());
