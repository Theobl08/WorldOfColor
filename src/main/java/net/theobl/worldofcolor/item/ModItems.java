...
public class ModItems {
    ...
    public static final Map<DyeColor, DeferredItem<Item>> COLORED_SIGNS = registerColored("sign");
    public static final Map<DyeColor, DeferredItem<Item>> COLORED_HANGING_SIGNS = registerColored("hanging_sign");
    public static final Map<DyeColor, DeferredItem<Item>> COLORED_BOATS = registerColored("boat");
    public static final Map<DyeColor, DeferredItem<Item>> COLORED_CHEST_BOATS = registerColored("chest_boat");
    public static final Map<DyeColor, DeferredItem<Item>> COLORED_COPPER_GOLEM_STATUES = registerColored("copper_golem_statue");
    public static final Map<DyeColor, DeferredItem<Item>> COLORED_WAXED_COPPER_GOLEM_STATUES = registerColored("waxed_copper_golem_statue");
    public static final Map<DyeColor, DeferredItem<Item>> COLORED_CAULDRONS = registerColored("cauldron");
    public static final Map<DyeColor, DeferredItem<Item>> COLORED_DECORATED_POTS = registerColored("decorated_pot");
    public static final Map<DyeColor, DeferredItem<Item>> COLORED_ITEM_FRAMES = registerColored("item_frame");
        ...
        for(DyeColor color : COLORS) {
            ...
            DeferredItem<Item> item = switch (key) {
                case "sign" -> ITEMS.registerItem(color.getName() + "_sign",
                        p -> new SignItem(ModBlocks.COLORED_SIGNS.get(color).get(), ModBlocks.COLORED_WALL_SIGNS.get(color).get(), p),
                        p -> p.stacksTo(16).useBlockDescriptionPrefix());

                case "hanging_sign" -> ITEMS.registerItem(color.getName() + "_hanging_sign",
                        p -> new HangingSignItem(ModBlocks.COLORED_HANGING_SIGNS.get(color).get(), ModBlocks.COLORED_WALL_HANGING_SIGNS.get(color).get(), p),
                        p -> p.stacksTo(16).useBlockDescriptionPrefix());

                case "boat" -> ITEMS.registerItem(color.getName() + "_boat",
                        p -> new BoatItem(ModEntityType.COLORED_BOATS.get(color).get(), p),
                        p -> p.stacksTo(1));

                case "chest_boat" -> ITEMS.registerItem(color.getName() + "_chest_boat",
                        p -> new BoatItem(ModEntityType.COLORED_CHEST_BOATS.get(color).get(), p),
                        p -> p.stacksTo(1));

                case "copper_golem_statue" -> ITEMS.registerItem(color.getName() + "_copper_golem_statue",
                        p -> new BlockItem(ModBlocks.COLORED_COPPER_GOLEM_STATUES.get(color).get(), p),
                ...
                case "waxed_copper_golem_statue" -> ITEMS.registerItem("waxed_" + color.getName() + "_copper_golem_statue",
                        p -> new BlockItem(ModBlocks.COLORED_WAXED_COPPER_GOLEM_STATUES.get(color).get(), p),
                        p -> p.component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)).useBlockDescriptionPrefix());

                case "cauldron" -> ITEMS.registerItem(color.getName() + "_cauldron",
                        p -> new BlockItem(ModBlocks.COLORED_CAULDRONS.get(color).get(), p) {
                                    public void registerBlocks(Map<Block, Item> map, Item self) {
                                        super.registerBlocks(map, self);
                                        map.put(ModBlocks.COLORED_WATER_CAULDRONS.get(color).get(), self);
                                        map.put(ModBlocks.COLORED_LAVA_CAULDRONS.get(color).get(), self);
                                        map.put(ModBlocks.COLORED_POWDER_SNOW_CAULDRONS.get(color).get(), self);
                                        map.put(ModBlocks.COLORED_DYED_WATER_CAULDRONS.get(color).get(), self);
                                    }
                                }, Item.Properties::useBlockDescriptionPrefix);

                case "decorated_pot" -> ITEMS.registerItem(color.getName() + "_decorated_pot",
                        p -> new BlockItem(ModBlocks.COLORED_DECORATED_POTS.get(color).get(), p),
                ...
                case "item_frame" -> ITEMS.registerItem(color.getName() + "_item_frame",
                        p -> new ItemFrameItem(ModEntityType.COLORED_ITEM_FRAMES.get(color).get(), p));
