...
public class ModMaterial {
    public static final List<SpriteId> COPPER_CHEST_LOCATION = new ArrayList<>();
    public static final List<SpriteId> COPPER_CHEST_LOCATION_LEFT = new ArrayList<>();
    public static final List<SpriteId> COPPER_CHEST_LOCATION_RIGHT = new ArrayList<>();
