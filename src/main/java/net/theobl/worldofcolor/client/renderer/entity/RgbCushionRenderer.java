...
public class RgbCushionRenderer extends CushionRenderer {
    public RgbCushionRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    public void extractRenderState(Cushion cushion, CushionRenderState state, float partialTicks) {
        ...
        state.texture = WorldOfColor.asResource("textures/entity/cushion/rgb_cushion.png");
    }
}
